...
def train_model(save_folder,name,train_type='early_stopping', train_from_scratch = True):
    train_loss=[]
    valid_loss=[]
    ...
    print()
    x_train,y_train=get_data("Datasets/Hotel/data_for_model/transformer/Hotel_train_part_1.pkl",27)
    # size_val=int(0.8*x_train.shape[0])
    # x_val, y_val = x_train[size_val:], y_train[size_val:]
    # x_train,y_train=x_train[0:size_val],y_train[0:size_val]
    ...
    x_test,y_test=get_data("Datasets/Hotel/data_for_model/transformer/Hotel_train_part_2.pkl",27)
    ...
    if train_from_scratch != True:
        model.load_state_dict(torch.load("Weights/pretrained/transformer/god.pth"))
...
if __name__ == '__main__':
    ...
    # train
    train_loss, valid_loss = train_model("Weights/Hotel/transformer/random/","random_hotel_1", train_from_scratch =True)
